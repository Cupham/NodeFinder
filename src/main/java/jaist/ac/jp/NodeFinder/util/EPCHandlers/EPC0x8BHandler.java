	...
	public static void refreshBusinessFacilityCode(Object obj, String newVal) {
		if(obj instanceof eSuperClass) {
			...
			if(dev.getType() == DeviceIDEnum.Profile){
				...
				if(!newVal.equals(profile.getBusinessFacilityCode())) {
					profile.setBusinessFacilityCode(newVal);
				...
				if(!newVal.equals(light.getBusinessFacilityCode())) {
					light.setBusinessFacilityCode(newVal);
					//TODO: More operation can be added here
				}
