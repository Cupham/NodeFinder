	...
	public static void refreshManufacturerCode(Object obj, String newVal) {
		if(obj instanceof eSuperClass) {
			...
			if(dev.getType() == DeviceIDEnum.Profile){
				...
				if(!newVal.equals(profile.getManufacturerCode())) {
					profile.setManufacturerCode(newVal);
				...
				if(!newVal.equals(light.getManufacturerCode())) {
					light.setManufacturerCode(newVal);
					//TODO: More operation can be added here
				}
