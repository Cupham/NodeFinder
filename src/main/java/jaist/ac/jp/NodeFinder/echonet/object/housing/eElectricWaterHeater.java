...
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.HeatingShiftTime;
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.WaterHeaterSetting;
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xB0:
							refreshAutomaticHeatingSetting(EchonetDataConverter.WaterHeaterSetting.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xC2:
							refreshAlarmStatus(EchonetDataConverter.dataTo4BitMapcode(resultData));
						...
						break;
						case xC7:
							if(EchonetDataConverter.dataToInteger(resultData) == 1) {
						...
						break;
						case xC8:
							refreshHeatingStartingTime(EchonetDataConverter.HeatingShiftTime.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xC9:
							refreshNumberOfShift(EchonetDataConverter.dataToInteger(resultData));
						...
						break;
						case xCA:
							refreshDaytimeHeatingShiftTime1(EchonetDataConverter.HeatingShiftTime.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xCB:
							long b1 = EchonetDataConverter.longFromByte(resultData.toBytes()[0], resultData.toBytes()[1],
																		resultData.toBytes()[3], resultData.toBytes()[4]);
							long b2 = EchonetDataConverter.longFromByte(resultData.toBytes()[5], resultData.toBytes()[6],
																		resultData.toBytes()[7], resultData.toBytes()[8]);
							long b3 = EchonetDataConverter.longFromByte(resultData.toBytes()[9], resultData.toBytes()[10],
																		resultData.toBytes()[11], resultData.toBytes()[12]);
							long b4 = EchonetDataConverter.longFromByte(resultData.toBytes()[13], resultData.toBytes()[14],
						...
						break;
						case xCC:
							short v1 = EchonetDataConverter.shortFromByte(resultData.toBytes()[0], resultData.toBytes()[1]);
							short v2 = EchonetDataConverter.shortFromByte(resultData.toBytes()[2], resultData.toBytes()[3]);
							short v3 = EchonetDataConverter.shortFromByte(resultData.toBytes()[4], resultData.toBytes()[5]);
							short v4 = EchonetDataConverter.shortFromByte(resultData.toBytes()[6], resultData.toBytes()[7]);
						...
						break;
						case xCD:
							refreshDaytimeHeatingShiftTime2(EchonetDataConverter.HeatingShiftTime.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xCE:
							long b12 = EchonetDataConverter.longFromByte(resultData.toBytes()[0], resultData.toBytes()[1],
																		resultData.toBytes()[3], resultData.toBytes()[4]);
							long b22 = EchonetDataConverter.longFromByte(resultData.toBytes()[5], resultData.toBytes()[6],
																		resultData.toBytes()[7], resultData.toBytes()[8]);
							long b32 = EchonetDataConverter.longFromByte(resultData.toBytes()[9], resultData.toBytes()[10],
																		resultData.toBytes()[11], resultData.toBytes()[12]);
						...
						break;
						case xCF:
							short v12 = EchonetDataConverter.shortFromByte(resultData.toBytes()[0], resultData.toBytes()[1]);
							short v22 = EchonetDataConverter.shortFromByte(resultData.toBytes()[2], resultData.toBytes()[3]);
							short v32 = EchonetDataConverter.shortFromByte(resultData.toBytes()[4], resultData.toBytes()[5]);
