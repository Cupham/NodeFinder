...
import jaist.ac.jp.NodeFinder.echonet.object.utils.eConverter.FanOperation;
...
public class eElectricStorageHeater extends eDataObject{
	...
	public eElectricStorageHeater(Node node,EOJ eoj) {
		...
		setType(eDeviceType.ElectricStorageHeater);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xA1:
							refreshFanOperationStatus(eConverter.FanOperation.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xC1:
							refreshHeatStorageTemperatureSetting(eConverter.dataToInteger(resultData));
						...
						break;
						case xC2:
							refreshStoredHeatTemperature(eConverter.dataToInteger(resultData));
						...
						break;
						case xC5:
							refreshMidnightPowerDurationSetting(eConverter.dataToInteger(resultData));
						...
						break;
						case xC6:
							refreshMidnightStartTimeSetting(eConverter.dataToInteger(resultData));
