...
import jaist.ac.jp.NodeFinder.echonet.object.utils.eConverter.ShowcaseShape;
import jaist.ac.jp.NodeFinder.echonet.object.utils.eConverter.ShowcaseType;
...
public class eCommercialShowcase extends eDataObject{
	...
	public eCommercialShowcase(Node node,EOJ eoj) {
		...
		setType(eDeviceType.CommercialShowcase);
	}
			...
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					switch (resultData.getEPC()) 
					{
						...
						break;
						case xE3:
							refreshInternalTemperature(eConverter.dataToInteger(resultData));
						...
						break;
						case xEF:
							refreshInsideCaseSettingTemperature(eConverter.dataToInteger(resultData));
						...
						break;
						case xD0:
							refreshShowcaseTypeInfor(eConverter.ShowcaseType.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xD3:
							refreshShowcaseShapeInfor(eConverter.ShowcaseShape.fromCode(resultData.toBytes()[0]));
