...
public class EPC0x8EHandler {
	private static final Logger logger = Logger.getLogger(EPC0x8EHandler.class.getName());
	public static void refreshProductDate(Object obj, Date newVal) {
		...
		if(obj instanceof eSuperObject) {
			...
			if(dev.getProductDate() != newVal) {
				dev.setProductDate(newVal);
				//TODO: More operation can be added here
				eTrigger.productionDateChanged(dev);
			}
		}else {
