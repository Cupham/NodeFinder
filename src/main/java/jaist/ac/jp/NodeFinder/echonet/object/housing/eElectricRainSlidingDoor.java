...
public class eElectricRainSlidingDoor extends eDataObject{
	private static final Logger logger = Logger.getLogger(eElectricRainSlidingDoor.class.getName());
	private Timer timer;
	...
	public eElectricRainSlidingDoor(Node node,EOJ eoj) {
		super(node, eoj);
		this.setGroupCode((byte) 0x02);
		this.setClassCode((byte) 0x63);
		this.setInstanceCode(eoj.getInstanceCode());
		setType(DeviceIDEnum.ElectricRainSlidingDoor);
	}
