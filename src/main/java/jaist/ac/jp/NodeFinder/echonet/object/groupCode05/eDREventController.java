...
import jaist.ac.jp.NodeFinder.echonet.object.utils.eConverter.DRProgramType;
...
public class eDREventController extends eDataObject{
	...
	public eDREventController(Node node,EOJ eoj) {
		...
		setType(eDeviceType.DREventController);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xD0:
							refreshBusinessID(eConverter.dataToString(resultData));
						...
						break;
						case xD1:
							refreshDRProgramType(eConverter.DRProgramType.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xD2:
							refreshProgramID(eConverter.dataToString(resultData));
						...
						break;
						case xD3:
							refreshCurrentValidEventInfor(eConverter.dataToString(resultData));
						...
						break;
						case xD4:
							refreshNextValidEventInfor(eConverter.dataToString(resultData));
						...
						break;
						case xD5:
							refreshFutureEventInforNotificationIDList(eConverter.dataToString(resultData));
						...
						break;
						case xD6:
							refreshPastEventInforNotificationIDList(eConverter.dataToString(resultData));
						...
						break;
						case xD7:
							refreshNewestReceivedEventNotificationID(eConverter.dataToString(resultData));
						...
						break;
						case xD8:
							refreshOldestReceivedEventNotificationID(eConverter.dataToString(resultData));
						...
						break;
						case xD9:
							refreshNotificationIDDesignation(eConverter.dataToString(resultData));
						...
						break;
						case xE0:
							refreshEventInfor(eConverter.dataToString(resultData));
