...
public class eGasHeatCommercialAirConditionerIndoorUnit extends eDataObject{
	private static final Logger logger = Logger.getLogger(eGasHeatCommercialAirConditionerIndoorUnit.class.getName());
	private Timer timer;
	...
	public eGasHeatCommercialAirConditionerIndoorUnit(Node node,EOJ eoj) {
		super(node, eoj);
		this.setGroupCode((byte) 0x01);
		this.setClassCode((byte) 0x58);
		this.setInstanceCode(eoj.getInstanceCode());
		setType(eDeviceType.GasHeatCommercialAirconditionerIndoorUnit);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xB0:
							refreshOperationModeSetting(eConverter.AirconditionerOperationMode.
						...
						break;
						case xAE:
							refreshCurrentFunction(eConverter.AirconditionerOperationMode.
									fromCode(resultData.toBytes()[0]));
