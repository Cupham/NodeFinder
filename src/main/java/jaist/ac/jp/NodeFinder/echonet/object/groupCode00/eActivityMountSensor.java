...
public class eActivityMountSensor extends eDataObject{
	...
	public eActivityMountSensor(Node node,EOJ eoj) {
		...
		setType(eDeviceType.ActivityMountSensor);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xE0:
							refreshActivityMountLevel1(eConverter.dataToLevel(resultData));
						...
						break;
						case xE2:
							refreshActivityMountLevel2(eConverter.dataToLevel(resultData));
