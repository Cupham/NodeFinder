...
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.FITContractType;
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.OutputPowerRestraint;
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.SelfConsumptionType;
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.SystemInterconnectedType;
...
public class eHouseholdSolarPowerGeneration extends eDataObject{
	...
	public eHouseholdSolarPowerGeneration(Node node,EOJ eoj) {
		...
		setType(DeviceIDEnum.HomeSolarPowerGeneration);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xA0:
							refreshOutputPowerControlSetting1(EchonetDataConverter.dataToInteger(resultData));
						...
						break;
						case xA1:
							refreshOutputPowerControlSetting2(EchonetDataConverter.dataToInteger(resultData));
						...
						break;
						case xC1:
							refreshFITContractType(EchonetDataConverter.FITContractType.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xC2:
							refreshSelfConsumptionType(EchonetDataConverter.SelfConsumptionType.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xC3:
							refreshCapacityApprovedByEquipment(EchonetDataConverter.dataToInteger(resultData));
						...
						break;
						case xC4:
							refreshConversionCoefficient(EchonetDataConverter.dataToInteger(resultData));
						...
						break;
						case xD0:
							refreshSystemInterconnectedType(EchonetDataConverter.SystemInterconnectedType.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xD1:
							refreshOutputPowerRestraint(EchonetDataConverter.OutputPowerRestraint.fromCode(resultData.toBytes()[0]));
						...
						break;
						case xE0:
							refreshInstantaneousEletrictAmountGenerated(EchonetDataConverter.dataToInteger(resultData));
						...
						break;
						case xE1:
							refreshCumulativeEletrictAmountGenerated(EchonetDataConverter.dataToLong(resultData)*0.001f);
						...
						break;
						case xE8:
							refreshRatedPowerGenerationOutput(EchonetDataConverter.dataToInteger(resultData));
