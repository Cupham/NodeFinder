...
public class eCommercialAirConditionerOutdoorUnit extends eDataObject{
	...
	public eCommercialAirConditionerOutdoorUnit(Node node,EOJ eoj) {
		...
		setType(DeviceIDEnum.CommercialAirconditionerOutdoorUnit);
	}
			...
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					switch (resultData.getEPC()) 
					{
						...
						break;
						case xDB:
							refreshMeasuredPowerConsumption(EchonetDataConverter.dataToLong(resultData));
						...
						break;
						case xDD:
							refreshPossiblePowerSaving(EchonetDataConverter.dataToLong(resultData));
						...
						break;
						case xDE:
							refreshRestrictingPowerConsumptionSetting(EchonetDataConverter.dataToLong(resultData));
