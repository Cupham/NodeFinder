...
import jaist.ac.jp.NodeFinder.util.EchonetDataConverter.TemperatureSetting;
...
public class eFloorHeater extends eDataObject{
	...
	public eFloorHeater(Node node,EOJ eoj) {
		...
		setType(DeviceIDEnum.FloorHeater);
	}
			...
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					switch (resultData.getEPC()) 
					{
						...
						break;
						case xE1:
							refreshTemperatureSetting2(EchonetDataConverter.TemperatureSetting.fromCode(resultData.toBytes()[0]));
