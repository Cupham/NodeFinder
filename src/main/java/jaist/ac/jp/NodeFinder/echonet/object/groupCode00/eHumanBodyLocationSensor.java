...
public class eHumanBodyLocationSensor extends eDataObject{
	...
	public eHumanBodyLocationSensor(Node node,EOJ eoj) {
		...
		setType(eDeviceType.HumanBodyLocationSensor);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xE0:
							refreshHumanBodyDetectionLocation1(eConverter.dataToCoordinator(resultData));
						...
						break;
						case xE1:
							refreshMaxNumberofHumanBodyID(eConverter.dataToShort(resultData));
						...
						break;
						case xE2:
							refreshHumanBodyDetectionLocation2(eConverter.dataToCoordinator(resultData));
						...
						break;
						case xE3:
							refreshHumanBodyExistenceInfor(eConverter.dataToByte(resultData));
