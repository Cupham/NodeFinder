...
public class eElectricShutter extends eDataObject{
	private static final Logger logger = Logger.getLogger(eElectricShutter.class.getName());
	private Timer timer;
	...
	public eElectricShutter(Node node,EOJ eoj) {
		super(node, eoj);
		this.setGroupCode((byte) 0x02);
		this.setClassCode((byte) 0x61);
		this.setInstanceCode(eoj.getInstanceCode());
		setType(DeviceIDEnum.ElectricShutter);
	}
