...
public class eElectricEnergySensor extends eDataObject{
	...
	public eElectricEnergySensor(Node node,EOJ eoj) {
		...
		setType(eDeviceType.ElectricEnergySensor);
	}
		...
		try {
			service.doGet(this.getNode(), this.getEoj(), epcs, 5000, new GetListener() {
			    ...
			    public void receive(GetResult result, ResultFrame resultFrame, ResultData resultData) {
					...
					{
						case xE0:
							refreshCumulativeElectricEnergyValue(eConverter.dataToLong(resultData)*0.001f);
						...
						break;
						case xE1:
							refreshMediumCapacitySensorInstantaneousElectricEnergy(eConverter.dataToLong(resultData));
						...
						break;
						case xE2:
							refreshSmallCapacitySensorInstantaneousElectricEnergy(eConverter.dataToShort(resultData)*0.1f);
						...
						break;
						case xE3:
							refreshLargeCapacitySensorInstantaneousElectricEnergy(eConverter.dataToShort(resultData)*0.1f);
						...
						break;
						case xE4:
							refreshCumulativeElectricEnergyMeasureLog(eConverter.dataToLong(resultData)*0.001f);
						...
						break;
						case xE5:
							refreshEffectiveVoltage(eConverter.dataToShort(resultData));
