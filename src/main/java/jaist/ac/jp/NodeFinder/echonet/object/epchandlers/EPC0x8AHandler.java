...
public class EPC0x8AHandler {
	private static final Logger logger = Logger.getLogger(EPC0x8AHandler.class.getName());
	public static void refreshManufacturerCode(Object obj, String newVal) {
		...
		if(obj instanceof eSuperObject) {
			...
			if(!newVal.equals(dev.getManufacturerCode())) {
				dev.setManufacturerCode(newVal);
				eTrigger.manufacturerCodeChanged(dev);
			}
		}else {
